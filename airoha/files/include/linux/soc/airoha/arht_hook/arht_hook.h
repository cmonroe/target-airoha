...
extern ecnt_ret_val __ARHT_HOOK(unsigned int maintype, unsigned int subtype,struct ecnt_data *in_data);
extern ecnt_ret_val __ECNT_HOOK(unsigned int maintype, unsigned int subtype,struct ecnt_data *in_data);
