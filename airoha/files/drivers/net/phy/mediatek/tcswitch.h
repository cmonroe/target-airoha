...
#define SPECIAL_RULE_NUM 	0		/*general set: 0*/
#define DMAC_RULE_NUM		0		/*general set: 3*/
#define SMAC_RULE_NUM		0		/*general set: 3*/
#define VLAN_RULE_NUM		0		/*general set: 8*/

#define PATTERN_FOR_SPECIAL_NUM		(5 + SPECIAL_RULE_NUM)
...
typedef struct{
	...
	u32 acl_class_idx: 	5 ;
	u32 reserved_1: 		2 ;
	u32 rate_mode: 		1 ;	/*1:trtcm, 0:acl rate*/
	u32 reserved_2: 		2 ;
	u32 drop_pcd_g: 		3 ;
	u32 drop_pcd_y: 		3 ;
	u32 drop_pcd_r: 		3 ;
...
void periodChk(void);
void refillPhyDefVal(u32 enetPhyAddr, u32 phyReg, u32 miiData);
